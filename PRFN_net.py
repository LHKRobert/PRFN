...
def build_PRFN(image_size, res_num, F_name, F, F_trainable, SeparableConv=False):
	"""
	Construct an PRFN network built using deep separable convolutional residual blocks, 
	...
	x_3 = residual_block(x_2,[64,128],3,size_op="down",block_num='down_2') #64
	x_3 = Dropout(drop)(x_3)

	x_4 = residual_block(x_3,[128,256],3,size_op="down",block_num='down_3') #32
	x_4 = Dropout(drop)(x_4)

	x_5 = residual_block(x_4,[256,512],3,size_op="down",block_num='down_4') #16
	x_5 = Dropout(drop)(x_5)

	x = residual_block(x_5,[512,512],3,size_op="none",block_num='none_1') #16
	x = Dropout(drop)(x)
